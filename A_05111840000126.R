...
# 1c
# tentukan apakah terdapat pengaruh yang signifikan secara statistika dalam hal kadar
# saturasi oksigen , sebelum dan sesudah melakukan aktivitas jika diketahui tingkat signifikansi ???? = 5% 
# pengaruh yang signifikan secara statistika dalam hal kadar saturasi
# serta H0 : "tidak ada oksigen , sebelum dan sesudah melakukan aktivitas ????"
